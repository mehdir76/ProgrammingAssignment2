...
makeCacheMatrix <- function(x = matrix()) {
         ...
         set <- function(y) {      
           ...
           ## Create function to set the value of cache_mtr in cache to the value of local_mtr passed 
           ## in the call to '$set_cache_mtr. 
           set_cache_mtr <- function(local_mtr) cache_mtr <<- local_mtr            
           ## Create function to retrieve value of cache_mtr from cache and return cache_mtr to the caller
...
cacheSolve <- function(x, ...) {
         ...
         ## Call x$set_cache_mtr() in makeCacheMatrix to set mtr in the cache environment 
         ## to the local non-NULL inverted result in last_matrix 
